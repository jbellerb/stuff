...
# BEGIN CHANGES
load("@prelude//apple:apple_bundle.bzl", "AppleBundlePartListConstructorParams", "get_apple_bundle_part_list")
load("@prelude//apple:apple_bundle_destination.bzl", "AppleBundleDestination", "bundle_relative_path_for_destination")
load("@prelude//apple:apple_bundle_part.bzl", "AppleBundlePart", "assemble_bundle", "bundle_output", "get_bundle_dir_name")
load("@prelude//apple:apple_bundle_types.bzl", "AppleBundleInfo")
load("@prelude//apple:apple_bundle_utility.bzl", "get_product_name")
load("@prelude//apple:apple_dsym.bzl", "DSYM_SUBTARGET", "DWARF_AND_DSYM_SUBTARGET", "EXTENDED_DSYM_INFO_SUBTARGET", "get_apple_dsym", "get_apple_dsym_info_json", "get_deps_debuggable_infos")
load("@prelude//apple:apple_entitlements.bzl", "entitlements_link_flags")
load("@prelude//apple:apple_rpaths.bzl", "get_rpath_flags_for_tests")
load("@prelude//apple:apple_sdk.bzl", "get_apple_sdk_name")
load("@prelude//apple:apple_sdk_metadata.bzl", "WatchSimulatorSdkMetadata")
load("@prelude//apple:debug.bzl", "AppleDebuggableInfo")
load("@prelude//apple:xcode.bzl", "apple_populate_xcode_attributes")
load("@prelude//apple:xctest_swift_support.bzl", "XCTestSwiftSupportInfo")
# END CHANGES
...
# BEGIN CHANGES
    toolchain = ctx.attrs._apple_xctoolchain[AppleToolchainInfo]
